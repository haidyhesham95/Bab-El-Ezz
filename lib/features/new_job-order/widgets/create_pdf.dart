...
class PdfGenerator {
  ...
  static init()async{
    arFont = Font.ttf( (await rootBundle.load("assets/fonts/Cairo-Arabic-Regular.ttf")) );
  }
  static Future<void> createPdf() async {
          ...
          return Column(
            ...
            children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          Text("عدد الكيلو متر: ", style: TextStyle(fontSize: 20)),
              ...
              Table.fromTextArray(
                context: context,
                data: <List<String>>[
                  <String>['الاجمالي',' المصنعية ',' الخصم ','السعر', 'الكمية', 'الصنف'],
    ...
    final file = File("${output.path}/انهاء امر الشغل");
